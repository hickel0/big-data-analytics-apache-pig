fs -rm -f -r -R /user/hadoop/outputs/team_joined;

-- Load team trad

team_traditional_raw =LOAD '/user/hadoop/data/team_traditional.csv'
    USING PigStorage(',')
    AS (
        gameid:chararray,
        date:chararray,
...
traditional_raw =
    LOAD '/user/hadoop/data/traditional.csv'
    USING PigStorage(',')
    AS (
        gameid:chararray,
        date:chararray,
...
STORE joined INTO '/user/hadoop/outputs/team_joined'
    USING PigStorage(',');